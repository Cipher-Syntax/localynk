...
const GuideAvailability = () => {
    ...
    // Parse data passed from AttractionDetails
    ...
    const renderCalendar = () => {
        ...
        const startingDay = 2; // Tuesday
        const days = ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'];
        const currentMonth = "November 2025";

        const calendarGrid = [];
        
        // Blank spots for start of month
        ...
        for (let i = 1; i <= daysInMonth; i++) {
            ...
            // Check availability (Visual only)
            ...
            calendarGrid.push(
                <View 
                    ...
                    style={[
                        styles.calDay, 
                        isAvailable && styles.calDayAvailable,
                        !isAvailable && styles.calDayDisabled
                    ]}
                >
                    <Text style={[
                        styles.calDayText, 
                        isAvailable && styles.calDayTextAvailable
                    ]}>{i}</Text>
                </View>
            );
        }
        ...
        <View style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <Text style={styles.subText}>
                    This is {guideName}'s standard schedule and itinerary.
                </Text>
                ...
                {accommodations.length > 0 && (
                    <View style={styles.sectionBox}>
                        <View style={styles.boxHeader}>
                            ...
                            <Text style={styles.boxTitle}>{guideName}'s Accommodations</Text>
                        </View>
            ...
            {/* FOOTER - Navigate to Full Details */}
            <View style={styles.footer}>
                ...
                <TouchableOpacity 
                    ...
                    onPress={() => router.push({
                        ...
                        params: { guideId: guideId } // Pass ID to next screen
                    })}
                >
